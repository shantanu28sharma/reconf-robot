...
class Robot:
    ...
    def simulate_tripod(self, inc, time):
        ...
        self.post_process()
        for i in range(time):
            self.f2.inc_up_angle(-inc)
            self.m1.inc_up_angle(inc)
            self.b2.inc_up_angle(-inc)
            self.m2.inc_up_angle(inc)
            self.b1.inc_up_angle(-inc)
            self.f1.inc_up_angle(-inc)
